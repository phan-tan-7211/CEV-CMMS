...
export function MasterDataFormScreen({ title, fields, onBack, onSubmit, children, submitDisabled = false }: {
  title: string
  fields: Field[]
  onBack: () => void
