...
export function CreateWorkOrderScreen({ equipmentId, onBack, onCreated }: { equipmentId: string; onBack: () => void; onCreated: (workOrderId: string) => void }) {
  ...
  return <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Pressable style={styles.selectRow}><Text style={styles.selectPlaceholder}>Chọn người thực hiện</Text><Ionicons name="chevron-forward" size={21} color="#98A2B3" /></Pressable>
      <Text style={styles.fieldLabel}>Nhóm được giao</Text>
      <Pressable style={styles.selectRow}><Text style={styles.selectPlaceholder}>Chọn nhóm thực hiện</Text><Ionicons name="chevron-forward" size={21} color="#98A2B3" /></Pressable>
    </ScrollView>
