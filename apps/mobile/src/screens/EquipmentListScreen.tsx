...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 62, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#FFFFFF', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#E5E5EF' },
  iconButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' },
  headerTitle: { fontSize: 20, fontWeight: '900', color: '#101828' },
  searchWrap: { minHeight: 47, marginHorizontal: 14, marginTop: 12, marginBottom: 9, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 9, borderRadius: 24, borderWidth: 1, borderColor: '#D7D8E5', backgroundColor: '#FFFFFF' },
  searchInput: { flex: 1, minHeight: 44, fontSize: 14, color: '#101828' },
  filterToolsRow: { minHeight: 50, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFFFFF' },
  ...
  summaryRow: { minHeight: 47, paddingHorizontal: 15, paddingBottom: 9, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#FFFFFF' },
  ...
  list: { flex: 1 },
  listContent: { paddingHorizontal: 14, paddingTop: 12, paddingBottom: 28, gap: 10 },
  listContentEmpty: { flexGrow: 1 },
  row: { minHeight: 92, paddingHorizontal: 10, paddingVertical: 8, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 18, borderWidth: StyleSheet.hairlineWidth, borderColor: '#E1E1EA', backgroundColor: '#FFFFFF', shadowColor: '#28324D', shadowOpacity: .04, shadowRadius: 7, shadowOffset: { width: 0, height: 2 }, elevation: 1 },
  rowPressed: { backgroundColor: '#F9FAFB' },
  rowCopy: { flex: 1, minWidth: 0 },
  titleRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  assetName: { flex: 1, fontSize: 15, lineHeight: 19, fontWeight: '900', color: '#101828' },
  statusDot: { width: 9, height: 9, borderRadius: 5, marginRight: 4 },
  assetId: { marginTop: 4, fontSize: 11.5, fontWeight: '800', color: '#667085' },
  meta: { marginTop: 4, fontSize: 11, color: '#98A2B3' },
