...
const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  { id: 'purchase-request-portal', group: 'NGHIỆP VỤ', title: 'Cổng yêu cầu mua hàng', description: 'Thiết lập cách tiếp nhận yêu cầu mua hàng.' },
  { id: 'work-orders', group: 'NGHIỆP VỤ', title: 'Lệnh công việc', description: 'Thiết lập trạng thái, biểu mẫu và quy tắc lệnh công việc.' },
  { id: 'work-order-statuses', group: 'NGHIỆP VỤ', title: 'Trạng thái lệnh công việc', description: 'Tùy chỉnh các trạng thái của lệnh công việc.' },
  { id: 'work-order-categories', group: 'NGHIỆP VỤ', title: 'Danh mục lệnh công việc', description: 'Quản lý danh mục phân loại lệnh công việc.' },
  { id: 'work-order-timers', group: 'NGHIỆP VỤ', title: 'Bộ hẹn giờ', description: 'Thiết lập bộ hẹn giờ cho thời gian thực hiện.' },
  { id: 'work-order-custom-fields', group: 'NGHIỆP VỤ', title: 'Trường tùy chỉnh lệnh công việc', description: 'Thêm trường riêng cho biểu mẫu lệnh công việc.' },
  { id: 'work-order-print-export', group: 'NGHIỆP VỤ', title: 'In & xuất lệnh công việc', description: 'Thiết lập nội dung in và xuất dữ liệu.' },
  { id: 'purchase-orders', group: 'NGHIỆP VỤ', title: 'Đơn đặt hàng', description: 'Thiết lập quy trình đơn đặt hàng.' },
  { id: 'purchase-order-categories', group: 'NGHIỆP VỤ', title: 'Danh mục đơn đặt hàng', description: 'Quản lý danh mục đơn đặt hàng.' },
